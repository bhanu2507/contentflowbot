...
class MainDialog extends ComponentDialog {
    ...
    async introStep(stepContext) {
        ...
        const messageText = stepContext.options.restartMsg ? stepContext.options.restartMsg : `If you want to add more language & territories then check revert to appropriate section`;
